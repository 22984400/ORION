  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        <p className="text-2xl font-semibold text-app-primary tracking-tight">
          {value}
        </p>
      ...
      <p className="text-2xs text-app-tertiary mt-3">{changeLabel}</p>
    </div>
  );
}
